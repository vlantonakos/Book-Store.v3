...
const Navbar = () => {
  ...
  return (
    <AppBar position="static" sx={{backgroundColor:'#3B4371'}}>
      <Container maxWidth="xl" sx={{display: 'flex',justifyContent:'center',alignItems: 'center'}}>
        ...
        >
          <AutoStoriesIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1,mt:0.5 }} />
          Book
        </Typography>
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              <Button
                ...
                component={Link}
                to={`/${page.toLowerCase()}`}
                sx={{ my: 0, color: 'white', display: 'block',borderRadius:'10%',
                "&:hover":{
                  color: 'gold'
                } }}
              >
